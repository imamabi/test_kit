...
latex_documents = [
    (master_doc, "test_kit.tex", "test_kit Documentation",
     "test_kit", "manual"),
]
...
man_pages = [
    (master_doc, "test_kit", "test_kit Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "test_kit", "test_kit Documentation",
     author, "test_kit", "Test project for MDA workshop",
     "Miscellaneous"),
]
